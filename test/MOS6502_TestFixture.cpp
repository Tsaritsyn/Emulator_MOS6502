...
void MOS6502_TestFixture::reset_registers() noexcept {
    AC = 0;
    X = 0;
    Y = 0;
    SR = 0;
...
void MOS6502_TestFixture::SetUp() {
    reset_registers();
    memory.reset();
}

std::expected<void, ROM::StackOverride> MOS6502_TestFixture::set_word(Word address, Word value) {
...
std::ostream &operator<<(std::ostream &os, const TestParameters &parameters) {
