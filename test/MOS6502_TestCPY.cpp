...
TEST_P(MOS6502_TestFixture_CPY, CPY_Immediate) {
    test_compare(CPY_IMMEDIATE,
                 GetParam(),
...
TEST_P(MOS6502_TestFixture_CPY, Test_ZeroPage) {
    constexpr static Byte address = 0xf0;
    test_compare(CPY_ZERO_PAGE,
                 GetParam(),
...
TEST_P(MOS6502_TestFixture_CPY, Test_Absolute) {
    constexpr static Word address = 0x02f0;
    test_compare(CPY_ABSOLUTE,
                 GetParam(),
...
INSTANTIATE_TEST_SUITE_P(TestEqual, MOS6502_TestFixture_CPY, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(TestGreater, MOS6502_TestFixture_CPY, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(TestLess, MOS6502_TestFixture_CPY, ::testing::Values(
