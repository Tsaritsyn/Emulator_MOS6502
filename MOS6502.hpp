...
namespace Emulator {
    ...
    union WordToBytes {
        ...
        void set_low(Byte value) { bytes[0] = value; }
        void set_high(Byte value) { bytes[1] = value; }

        [[nodiscard]] Byte get_low() const { return bytes[0]; }
        [[nodiscard]] Byte get_high() const { return bytes[1]; }
    };
    ...
    public:
        ...
        /// program counter is set to the value of RESET_LOCATION, cycle is set to 7
        void reset();
